...
Default value of ~fzf-async-extensions~ is ~(pass spotlight music chrome company)~.
...
| ~fzf-async-extensions~         | ~(pass spotlight music chrome company)~ | Extensions to load from ~extensions/~ during setup. |
