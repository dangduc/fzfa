...
Default value of ~fzf-async-extensions~ is ~(pass spotlight music chrome company mail)~.
...
| ~fzf-async-extensions~         | ~(pass spotlight music chrome company mail)~ | Extensions to load from ~extensions/~ during setup. |
