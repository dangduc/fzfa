...
The main difference is ~fzfa~ lets you modify the entire shell command
that's being used. Refer to https://github.com/minad/consult#asynchronous-search
...
#+HTML: <video src="https://github.com/user-attachments/assets/ec1c3eb6-78ae-4578-a588-24434a229ca6" controls style="max-width: 100%; height: auto;"></video>
