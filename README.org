...
Default value of ~fzf-async-extensions~ is ~(pass spotlight music chrome)~.
...
| ~fzf-async-extensions~         | ~(pass spotlight music chrome)~ | Extensions to load from ~extensions/~ during setup. |
