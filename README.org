...
Default value of ~fzfa-extensions~ is ~(ag chrome company emacs evil fd find flymake git grep hg hungry locate mail make music notmuch pass project rg shell spotlight ugrep)~.
