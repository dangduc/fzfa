...
| ~fzfa-outline~                | ~counsel-outline~                     | ~consult-outline~                   |
| ~fzfa-mark~                   | ~counsel-mark-ring~                   | ~consult-mark~                      |
| ~fzfa-global-mark~            | ~counsel-mark-ring~                   | ~consult-global-mark~               |
| ~fzfa-register~               | ~counsel-register~                    | ~consult-register-load~             |
| ~fzfa-flymake~                | —                                     | ~consult-flymake~                   |
| ~fzfa-flymake-project~        | —                                     | ~consult-flymake~ (with prefix arg) |
| ~fzfa-compile-error~          | ~counsel-compile~ (related)           | ~consult-compile-error~             |
| ~fzfa-project-find-file~      | ~counsel-projectile-find-file~        | —                                   |
| ~fzfa-project-find-dir~       | ~counsel-projectile-find-dir~         | —                                   |
| ~fzfa-project-buffer~         | ~counsel-projectile-switch-to-buffer~ | ~consult-project-buffer~            |
| ~fzfa-project-recentf~        | ~counsel-projectile-recentf~          | —                                   |
| ~fzfa-project-switch-project~ | ~counsel-projectile-switch-project~   | —                                   |
...
Default value of ~fzfa-extensions~ is ~(ag chrome company emacs evil fd find flymake git grep hg hungry info locate mail make music notmuch pass project rg shell spotlight ugrep)~.
