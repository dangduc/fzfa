...
Default value of ~fzfa-extensions~ is ~(ag chrome company emacs embark evil fd find flymake git grep hg hungry info locate mail make music notmuch org pass project rg shell spotlight ugrep)~.
